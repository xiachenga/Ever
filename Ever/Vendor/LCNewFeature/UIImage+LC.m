...
+ (instancetype)imageNamedForAdaptation:(NSString *)imageName
    ...
    if (IPHONE4 ) {
        ...
        realImageName = [NSString stringWithFormat:@"%@.jpg", realImageName];
    }
    
    if (IPHONE5 && iphone5) {
        
        realImageName = [NSString stringWithFormat:@"%@_iphone5.jpg", realImageName];
    }
    
    // 当前设备是iPhone6
    if (IPHONE6 && iphone6) {
        
        realImageName = [NSString stringWithFormat:@"%@_iphone6.jpg", realImageName];
    }
    
    // 当前设备是iPhone6P
    if (IPHONE6P && iphone6p) {
        
        realImageName = [NSString stringWithFormat:@"%@_iphone6p.jpg", realImageName];
    }
